...
* https://github.com/metanorma/metanorma-gb/issues/58[Measurements (GB/T 1.1 Annex I.)] The gem
...
* https://github.com/metanorma/metanorma-gb/issues/56[Fonts (GB/T 1.1 Annex J.)] The gem aligns
...
* https://github.com/metanorma/metanorma-gb/issues/57[Layout (GB/T 1.1 Clause 9.)]. The gem complies
