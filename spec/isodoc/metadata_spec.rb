...
<bibdata type="recommendation">
  ...
  <revision-date>2016-05-01</revision-date>
    ...
    INPUT
    expect(htmlencode(Hash[gbc.info(docxml, nil).sort].to_s)).to be_equivalent_to <<~"OUTPUT"
           {:accesseddate=>"2016-01-03", :committee=>"Food products", :confirmeddate=>"XXX", :createddate=>"2016-01-05", :docidentifier=>"NY/T&#x2002;PreCD3 17301-1&mdash;2016", :docmaintitleen=>"Cereals and pulses&mdash;", :docmaintitlezh=>"Cereals1&nbsp;", :docnumber=>"PreCD3 17301-1", :docparttitleen=>"&mdash;Part 1:  Rice", :docparttitlezh=>"&nbsp;&#x7b2c;1&#x90e8;&#x5206;:Rice1", :docsubtitleen=>"Specifications and test methods", :docsubtitlezh=>"Specifications1", :doctitle=>"Cereals and pulses&mdash;Specifications and test methods&mdash;Part 1:  Rice", :doctype=>"Recommendation", :docyear=>"2016", :draft=>"0.1", :draftinfo=>" (draft 0.1, 2016-05-01)", :editorialgroup=>[], :gbequivalence=>"IDT", :gbprefix=>"NY", :gbscope=>"sector", :ics=>"1322", :implementeddate=>"2016-01-04", :isostandard=>"ISO 123", :isostandardtitle=>"Rice Model document", :issueddate=>"XXX", :issuer=>"Ministry of Agriculture", :labelled_implementeddate=>"&#x5b9e;&#x65bd;: 2016-01-04", :labelled_publisheddate=>"&#x53d1;&#x5e03;: 2016-01-02", :libraryid_ccs=>"A 01, A 02", :libraryid_ics=>"1322", :libraryid_plan=>"XYZ", :obsoleteddate=>"XXX", :obsoletes=>nil, :obsoletes_part=>nil, :publisheddate=>"2016-01-02", :revdate=>"2016-05-01", :sc=>"XXXX", :secretariat=>"XXXX", :stage=>30, :stageabbr=>"PreCD3", :standard_agency=>nil, :standard_class=>"&#x4e2d;&#x534e;&#x4eba;&#x6c11;&#x5171;&#x548c;&#x56fd;XXXX&#x884c;&#x4e1a;&#x6807;&#x51c6;", :tc=>"XXXX", :updateddate=>"XXX", :wg=>"XXXX"}
    OUTPUT
  end
